    		...
    		<form method='POST'>
           		...
           		<div class="row mb-2">
          	    	...
          	    	<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-1">
        	            <input type='text' name='usu_login' id='usu_login' value='<?= $usu_login ?>' class="form-control" required='required'>
        	        </div>            
                </div>
           		...
           		<div class="row mb-2">
          	    	...
          	    	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-1">
        				<input type='password' name='usu_senha' id='usu_senha' value='<?= $usu_senha ?>' class="form-control" required='required'>
        			</div>
        		</div>
           		...
           		<div class="row mb-2">
          	    	...
          	    	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-1">
        				<input type='password' name='usu_senha_conf' id='usu_senha_conf' value='<?= $usu_senha ?>' class="form-control" required='required'>
        			</div>
        		</div>
